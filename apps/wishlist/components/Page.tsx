...
const Page = ({ title, children }: Props) => {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex flex-row items-center w-full h-14 sm:h-16 p-2 sm:p-4 gap-2 sm:gap-4 bg-inherit dark:sm:bg-slate-950 sm:border-b sm:border-gray-300 dark:sm:border-slate-800 dark:border-slate-800 text-black dark:text-slate-400 items-center text-semibold border-b border-transparent">
