...
const Page = ({ title, children }: Props) => {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex flex-row items-center w-full h-16 bg-inherit sm:bg-gray-50 sm:border-b sm:border-gray-300 sm:dark:bg-slate-900 dark:border-slate-800 text-black dark:text-slate-400 gap-2 sm:gap-4 items-center p-2 sm:p-4 text-semibold border-b border-transparent">
