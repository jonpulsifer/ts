...
FROM node:18.16.0-alpine@sha256:9036ddb8252ba7089c2c83eb2b0dcaf74ff1069e8ddf86fe2bd6dc5fecc9492d AS installer
RUN apk add --no-cache libc6-compat
...
FROM cgr.dev/chainguard/node:18.16.1@sha256:926be3c8db70b8329d84db337f955737d80466ecf252f04980a6a2db38fb4b28 AS runner
WORKDIR /app
